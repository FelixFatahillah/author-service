...
import (
	"author-service/internal/config"
	"author-service/internal/delivery"
...
func Execute() {
	...
	authorGapi := author.NewAuthorHandlerGrpcHandler(services.AuthorService)
	pb.RegisterAuthorServiceServer(rpcServer, authorGapi)
